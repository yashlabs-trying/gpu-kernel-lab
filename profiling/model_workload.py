...
def main():
    ...
    p.add_argument('--variant', choices=['baseline','triton_rms','triton_swiglu','triton_both','qwen_rms','fused_mlp','qwen_rms_fused_mlp','int4_decode','qwen_rms_int4_head','qwen_rms_int8_cuda','qwen_rms_int8_cuda_int4_head','qwen_rms_cuda_hybrid'], default='baseline')
    args = p.parse_args()
